<x-app-layout>
    <x-slot name="title">Teaching & Learning Center - Lecturer</x-slot>
    <x-slot name="header">
    ...
    <div class="flex h-screen bg-gray-50 overflow-hidden">
        ...
        <aside class="w-80 bg-white shadow-sm border-r border-gray-200 p-6">
            ...
            <div class="space-y-4">
                ...
                <!-- Quick Stats -->
                <div class="border-b border-gray-200 pb-4">
                    <h4 class="font-medium text-gray-900 mb-3">Activity Stats</h4>
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div class="text-center">
                            <div class="text-2xl font-bold text-green-600">{{ Auth::user()->taughtCourses()->count() }}</div>
        ...
        <p class="text-lg font-medium mb-6">
            Welcome, {{ Auth::user()->name }} (Lecturer)!
        </p>
                                ...
                                <div class="flex-1">
                                    <form onsubmit="addComment(event, {{ $post->id }})" class="flex space-x-2">
                                        <input 
                                            ...
                                            class="flex-1 px-3 py-2 border border-gray-300 rounded-full focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                            id="commentInput{{ $post->id }}"
                                            required
                                        >
                                        <button type="submit" class="px-4 py-2 bg-blue-600 text-white rounded-full hover:bg-blue-700 text-sm">
                                            Post
                                        </button>
                                    </form>
                                </div>
                            ...
                            <div class="flex-1">
                                ...
                                <div class="text-xs text-gray-500 mt-1">
                                    ...
                                    @if($post->comments_count > 1)
                                        • <span class="text-blue-600 cursor-pointer" onclick="toggleComments({{ $post->id }})">View all {{ $post->comments_count }} comments</span>
                                    @endif
                                </div>
                            </div>
                        </div>
        ...
        <aside class="w-64 bg-white shadow-sm border-l border-gray-200 p-6">
            <!-- Logo/Brand -->
            <div class="mb-8">
                <h2 class="text-xl font-bold text-blue-600">E-Learning</h2>
                <p class="text-sm text-gray-600">Lecturer Portal</p>
            </div>
                ...
                <div class="space-y-3">
                    <div class="flex items-center justify-between p-3 bg-green-50 rounded-lg">
                        <div class="flex items-center space-x-2">
                            ...
                            <span class="text-sm text-gray-700">Active Courses</span>
                        </div>
                        <span class="font-semibold text-green-600">{{ Auth::user()->taughtCourses()->count() }}</span>
                    </div>
                    ...
                    <div class="flex items-center justify-between p-3 bg-purple-50 rounded-lg">
                        ...
                        <span class="font-semibold text-purple-600">24</span>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-8">
                ...
                <div class="space-y-3">
                    <div class="flex items-start space-x-3">
                        ...
                        <div class="flex-1">
                            <p class="text-sm text-gray-700">New course created</p>
                    ...
                    <div class="flex items-start space-x-3">
                        ...
                        <div class="flex-1">
                            <p class="text-sm text-gray-700">Student enrolled</p>
        ...
        <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
            <div class="mt-3">
                ...
                <div class="flex justify-end space-x-3">
                    ...
                    <button onclick="sendSharedPost()" class="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700">
                        Share
                    </button>
                </div>
            </div>
    ...
    <script>
        ...
        function selectUserForSharing(userId, userName, userRole) {
            ...
            const isSelected = checkbox.classList.contains('bg-blue-500');
