    ...
    <div class="p-6">
        <div class="max-w-2xl mx-auto">
            <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                <h3 class="text-lg font-semibold text-gray-800 mb-4">Submit Feedback to Admin</h3>
                
                <form action="{{ route('L.feedback.store-to-admin') }}" method="POST">
                    @csrf
                    ...
                    <div class="space-y-6">
                        ...
                        <!-- Admin -->
                        <div>
                            <x-input-label for="admin_id" value="Admin" />
                            <select id="admin_id" name="admin_id" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                        ...
                        <div>
                            ...
                            <textarea id="content" name="content" rows="6" 
                                      ...
                                      placeholder="Please provide detailed feedback to admin..." required>{{ old('content') }}</textarea>
